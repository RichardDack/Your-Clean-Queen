...
const FeatureItem: React.FC<FeatureItemProps> = ({ imageSrc, imageAlt, title, description }) => {
  return (
    <div className="flex items-start gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
      ...
      <div>
        <h3 className="text-lg font-heading font-semibold text-gray-800 mb-2">{title}</h3>
...
export default function Feature() {
  ...
  return (
    <section id="features" className="py-16 bg-accent-cream">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <div className="mb-8 text-left">
              <p className="text-vibrant-green font-semibold text-lg mb-2">Why Choose Us?</p>
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-gray-800 mb-4">
                Expert Cleaners, World-Class Service
              </h2>
            </div>
            <p className="text-gray-700 leading-relaxed mb-6 text-lg">
              Your Clean Queen is dedicated to providing an exceptional cleaning experience. Our team is not only skilled and professional but also committed to understanding your unique needs. We combine meticulous attention to detail with eco-friendly practices to ensure your home is not just clean, but a healthy and happy space.
            </p>
            <p className="text-gray-700 leading-relaxed mb-8 text-lg">
              From regular maintenance to deep cleans, we bring a personal touch to our professional services, ensuring reliability and results you can trust. Experience the difference with Your Clean Queen.
            </p>
            <Link 
              href="#contact" 
