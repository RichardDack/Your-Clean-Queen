...
export default function Navbar() {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-300 ${
      ...
      <div className="hidden md:block container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex justify-between items-center py-3 md:py-4">
            ...
            <Link href="/" className="flex items-center group">
              <div className={`relative transition-all duration-300 ${
                ...
                <Image
                  ...
                  width={40}
                  height={40}
                  className={`w-8 h-8 md:w-12 md:h-12 transition-all duration-300 group-hover:scale-105 ${
                    isScrolled 
                      ? 'brightness-100' 
          ...
          <div className="hidden lg:flex items-center">
             <Link 
               href="#contact" 
               className={`ml-8 inline-flex items-center justify-center px-4 py-2 md:px-5 md:py-2.5 rounded-md shadow-sm text-sm md:text-base font-medium transition-colors ${
                 isScrolled 
                   ? 'text-white bg-vibrant-green hover:bg-vibrant-green-dark border-2 border-black' 
                   : 'text-vibrant-green bg-white hover:bg-gray-50 border-2 border-black'
               }`}
             >
                Get Quote
            </Link>
          ...
          <div className="lg:hidden flex items-center ml-4">
            ...
            >
              ...
              {isOpen ? (
                <svg className="block h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
              ) : (
                <svg className="block h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" /></svg>
              )}
            </button>
          </div>
        </div>
