        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><a href="#contact" className="hover:text-white transition-colors">Free Quotes</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-vibrant-green flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62,10.79C8.06,13.62 10.38,15.94 13.21,17.38L15.41,15.18C15.69,14.9 16.08,14.82 16.43,14.93C17.55,15.3 18.75,15.5 20,15.5A1,1 0 0,1 21,16.5V20A1,1 0 0,1 20,21A17,17 0 0,1 3,4A1,1 0 0,1 4,3H7.5A1,1 0 0,1 8.5,4C8.5,5.25 8.7,6.45 9.07,7.57C9.18,7.92 9.1,8.31 8.82,8.59L6.62,10.79Z"/>
                </svg>
                <a href="tel:01305233872" className="font-semibold hover:text-white transition-colors">01305 123 456</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:hello@yourcleanqueen.co.uk" className="hover:text-white transition-colors">hello@yourcleanqueen.co.uk</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span>Dorchester, Dorset</span>
              </div>
            </div>
            
            <a
              href="#contact"
              className="inline-block bg-vibrant-green hover:bg-vibrant-green-dark text-white font-bold px-6 py-3 rounded-lg transition-colors duration-300 mt-6 shadow-lg"
            >
              Book Free Quote
            </a>
          </div>
